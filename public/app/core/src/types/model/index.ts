...
export namespace Model {
  ...
  export const SamlIdpSettingsSchema = z.object({
    ...
    identityProviderKnownService: z.enum([
      Auth.SAML_KNOWN_IDENTITY_PROVIDERS.azure_ad,
      Auth.SAML_KNOWN_IDENTITY_PROVIDERS.google,
      Auth.SAML_KNOWN_IDENTITY_PROVIDERS.okta,
      Auth.SAML_KNOWN_IDENTITY_PROVIDERS.other,
    ]),
  });
  ...
  export const FileSchema = z
    .object({
      ...
      envParentId: z.string(),
      envsUpdatedAt: z.number().optional(),
      envsUpdatedAtByEnvironmentId: z.record(z.number()),
      envsEncryptedBy: z.record(z.string()),
      localsUpdatedAtByUserId: z.record(z.number()),
      localsUpdatedAt: z.number().optional(),
      localsEncryptedBy: z.record(z.string()),
      envsOrLocalsUpdatedAt: z.number().optional(),
  ...
  export const UserMessageSchema = z
    .object({
      ...
      isFile: z.literal(true).optional(),
      ...
      orgRoleIds: z.array(z.string()).optional(),
      appRoleIds: z.array(z.string()).optional(),

      expiresAt: z.number(),
      oneTimeVisible: z.literal(true).optional(),

      notify: z.literal(true).optional(),
      sticky: z.literal(true).optional(),
  ...
  export const CredentialSchema = z
    .object({
      ...
      serviceProvider: z.enum(["aws"]).optional(),
      format: z.enum(["json", "yaml", "env"]).optional(),

      isDefaultSelfHostedAWSCredentials: z.literal(true).optional(),

      autoRotate: z.literal(true).optional(),
      autoRotateStrategy: z.enum(["aws", "webhook"]).optional(),
      autoRotateWebhookEndpoint: z.string().optional(),
      autoRotateWebhookPubkey: z.string().optional(),
