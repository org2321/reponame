...
export namespace Blob {
  ...
  export const UserEncryptedKeySchema = EncryptedKeyBaseSchema.extend({
    ...
    changesetEncryptedKeyCreatedAt: z.number().optional(),
  ...
  export type SkeyParams =
    ...
    | {
        blobType: "variableData";
        envParentId: string;
        environmentId: string;
      }
    | ({
        blobType: "userMessage";
  ...
  export type UserEncryptedBlobsByEnvironmentIdOrComposite = Record<
    string,
    Blob.EncryptedBlob
  >;
}
