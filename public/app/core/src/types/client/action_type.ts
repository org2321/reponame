enum ActionType {
  ...
  HOST_UNREACHABLE = "envkey/client/HOST_UNREACHABLE",
  HOST_REACHABLE = "envkey/client/HOST_REACHABLE",
  ...
  CREATE_SCIM_PROVISIONING_PROVIDER = "envkey/client/CREATE_SCIM_PROVISIONING_PROVIDER",
  UPDATE_SCIM_PROVISIONING_PROVIDER = "envkey/client/UPDATE_SCIM_PROVISIONING_PROVIDER",

  REENCRYPT_PERMITTED_ENVS = "envkey/client/REENCRYPT_PERMITTED_ENVS",
}
