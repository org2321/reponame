...
export type PartialAccountState = {
  ...
  hostUnreachable: true | undefined;
...
export type PartialClientState = {
  ...
  provisioningProviderConfig:
    | { id?: string; endpointBaseUrl?: string; secret: string }
    | undefined;
  isUpdatingProvisioningProvider: true | undefined;
  updatingProvisioningProviderError: Client.ClientError | undefined;
...
export const defaultAccountState: PartialAccountState = {
  ...
  defaultClientState: PartialClientState = {
    ...
    samlSettingsByProviderId: undefined,
    ...
    provisioningProviderConfig: undefined,
    isUpdatingProvisioningProvider: undefined,
    updatingProvisioningProviderError: undefined,
