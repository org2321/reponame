...
import { Crypto, Api, Auth, Model } from "../";
...
namespace Client {
  ...
  export type ActionTypeWithContextMeta<ActionType, DispatchContextType = any> =
    ActionType & {
