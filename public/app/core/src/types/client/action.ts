...
export namespace Action {
  ...
  export type ClientActions = EnvUpdateActions & {
    ...
    ReencryptPermittedEnvs: {
      type: ActionType.REENCRYPT_PERMITTED_ENVS;
    };
    ...
    HostUnreachable: {
      type: ActionType.HOST_UNREACHABLE;
      payload: { hostUrl: string };
    };
    HostReachable: {
      type: ActionType.HOST_REACHABLE;
      payload: { hostUrl: string };
    };
    ...
    CreateScimProvisioningProvider: {
      type: ActionType.CREATE_SCIM_PROVISIONING_PROVIDER;
      payload: {
        nickname: string;
        authScheme: Auth.ProvisioningAuthScheme;
        secret?: string;
      };
    };
  };
