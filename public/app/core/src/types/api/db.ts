...
export namespace Db {
  ...
  export type Scope = { pkey: string; scope?: string };
  ...
  export type ObjectTransactionItems = {
    ...
    orderUpdateScopes?: [Required<Scope>, number][];
  };
  ...
  export type CliKeyPointer = z.infer<typeof CliKeyPointerSchema>;
  export const CliKeyPointerSchema = z
    .object({
      type: z.literal("cliKeyPointer"),
      skey: z.literal("cliKeyPointer"),
      orgId: z.string(),
      userId: z.string(),
    })
    .merge(DbObjectSchema);
  ...
  export const FileSchema = utils.intersection(
    Model.FileSchema,
    DbObjectSchema
  );
