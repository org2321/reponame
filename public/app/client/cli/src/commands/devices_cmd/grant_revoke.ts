...
export const command = [
  "grant-revoke [device-grant-id]",
  "revoke-grant [device-grant-id]",
];
export const desc = "Revoke a pending device grant.";
...
export const handler = async (
  ...
  if (!revokableDeviceGrants.length) {
    console.log("There are no pending device grants. No work was done.");
    return exit();
  }
  ...
  console.log(chalk.bold("The device grant was revoked successfully."));
