...
export const command = ["revoke [device]", "remove [device]"];
export const desc = "Remove a device and revoke its access.";
...
export const handler = async (
  ...
  console.log(chalk.bold("The device was revoked successfully."));
