...
export const command = [
  "grant-access [app] [user_email] [app_role_id]",
  "grant [app] [user_email] [app_role_id]",
];
export const desc = "Give a user access to an app.";
...
export const handler = async (
  ...
  console.log(chalk.bold("App role access was added successfully."));
  autoModeOut({
