...
export const OrgSettings: OrgComponent = (props) => {
  ...
  const {
    ...
    return {
      ...
      canManageEnvironmentRoles: g.authz.hasOrgPermission(
        graph,
        currentUserId,
  ...
  const renderManageEnvironmentRoles = () => {
    if (!canManageEnvironmentRoles) {
      return;
    }
    return <ui.ManageOrgEnvironmentRoles {...props} />;
  };
