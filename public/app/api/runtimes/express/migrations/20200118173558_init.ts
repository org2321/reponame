...
// Note: charset is set to utf8mb4 in the client connection, which results in the columns being created with that character set. The default engine for MySQL 5.7 and Aurora is InnoDB.
export const up = async (knex: Knex) => {
  ...
  await knex.schema.createTable("logs", (t) => {
    ...
    ([
      ...
      ["device", ["deviceId"]],
      ["base", []],
    ] as [string, string[]][]).forEach((arg) => applyLogIndexesV1(t)(arg));
  });
